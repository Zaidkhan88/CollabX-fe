...
import { formatAMPM, json_verify, nameTructed } from "../../meetingUtils/helper";
  ...
  return (
    ...
    >
      <div class="relative  w-full">
        ...
        <input
          type="text"
          className="py-4 text-base text-white border-gray-400 border bg-gray-700 rounded pr-10 pl-2 focus:outline-none w-full"
