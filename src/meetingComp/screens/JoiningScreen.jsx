...
import { MeetingDetailsScreen } from "../MeetingDetailsScreen.jsx";
...
import useMediaStream from "../../meetingHooks/useMediaStream";
import useIsMobile from "../../meetingHooks/useIsMobile";
import WebcamOffIcon from "../../meetingIcons/WebcamOffIcon.jsx";
import WebcamOnIcon from "../../meetingIcons/Bottombar/WebcamOnIcon.jsx";
import MicOffIcon from "../../meetingIcons/MicOffIcon.jsx";
import MicOnIcon from "../../meetingIcons/Bottombar/MicOnIcon.jsx";
import MicPermissionDenied from "../../meetingIcons/MicPermissionDenied.jsx";
import CameraPermissionDenied from "../../meetingIcons/CameraPermissionDenied.jsx";
import DropDown from "../DropDown.jsx";
import DropDownCam from "../DropDownCam.jsx";
import DropDownSpeaker from "../DropDownSpeaker.jsx";
              ...
              <div className="md:col-span-5 2xl:col-span-5 col-span-12 md:relative">
                <div className=" align-middle">
                  <h1 className="text-gray-400 text-2xl sm:text-xl font-bold text-center mt-4">
                    <img src={Logo} alt="Meeting Logo" className="w-12 h-12 mx-auto transition-transform duration-300 transform scale-100 hover:scale-95" />
                    <span className="">Welcome,{userQuery.data?.username}</span>
                  </h1>
